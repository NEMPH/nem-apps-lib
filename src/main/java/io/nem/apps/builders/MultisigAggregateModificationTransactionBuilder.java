 ...
 */
public class MultisigAggregateModificationTransactionBuilder {

	/**
	 * Instantiates a new multisig transaction builder.
	 */
	public MultisigAggregateModificationTransactionBuilder() {
	}
	...
	public ISender sender(Account sender) {
		return new MultisigAggregateModificationTransactionBuilder.Builder(sender);
	}
